...
_setText ctrlSetStructuredText (parseText format ["
	...
	You are Raptor Squadron Leader - Raptor 1<br /><br />
	...
	Working closely with Viking 2:1 Padre (or acting), your role is to ensure that all necessary airbourne tasks are carried out<br /><br />
